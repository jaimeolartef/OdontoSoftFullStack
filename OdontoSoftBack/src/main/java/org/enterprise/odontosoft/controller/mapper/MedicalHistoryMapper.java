...
//TODO REVISAR COMO SE ESTA DEVOLVIENDO EL ID DEL PACIENTE Y EL USUARIO EN EL RESPONSE DEBE SER STRING SOLO EL NOMBRE
    ...
    public static HistoriaClinicaResponse toDto(HistoriaClinica historiaClinica) {
        return HistoriaClinicaResponse.builder()
            ...
            .idpaciente(Objects.nonNull(historiaClinica.getIdpaciente()) ? historiaClinica.getIdpaciente().getNombreCompleto() : null)
            ...
            .idusuariomodificacion(Objects.nonNull(historiaClinica.getIdusuariomodificacion()) ? historiaClinica.getIdusuariomodificacion().getCodigo() : null)
