...
public class DetalleOdontogramaMapper {
    ...
    public static DetalleOdontograma toEntity(DetalleOdontogramaRequest detalleOdontogramaRequest) {
        return DetalleOdontograma.builder()
            ...
            .idusuariocreacion(Usuario.builder().codigo(detalleOdontogramaRequest.getIdusuariocreacion()).build())
            .fechacreacion(detalleOdontogramaRequest.getFechacreacion())
            .idusuariomodificacion(Objects.nonNull(detalleOdontogramaRequest.getIdusuariomodificacion()) ? Usuario.builder().codigo(detalleOdontogramaRequest.getIdusuariomodificacion()).build() : null)
    ...
    public static DetalleOdontogramaResponse toResponse(DetalleOdontograma detalleOdontograma) {
        return DetalleOdontogramaResponse.builder()
            ...
            .idusuariocreacion(detalleOdontograma.getIdusuariocreacion().getCodigo())
            .fechacreacion(detalleOdontograma.getFechacreacion())
            .idusuariomodificacion(Objects.nonNull(detalleOdontograma.getIdusuariomodificacion()) ? detalleOdontograma.getIdusuariomodificacion().getCodigo() : null)
